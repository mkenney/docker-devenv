...
2. Non-Mac users will need to make sure your user can [run docker without sudo](https://docs.docker.com/v1.8/installation/ubuntulinux/#create-a-docker-group).
3. Mac-users, you'll need to add some essential system utilities before proceeding:
