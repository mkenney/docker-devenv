 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class RpStandard_Sniffs_WhiteSpace_ScopeIndentSniff implements PHP_CodeSniffer_Sniff
{
    /**
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        for ($i = ($stackPtr + 1); $i < $phpcsFile->numTokens; $i++) {
            ...
            */
            $adjusted = false;
            if ($checkToken !== null
                && $tokens[$checkToken]['type'] !== 'T_START_HEREDOC'
                && $tokens[$checkToken]['type'] !== 'T_COMMENT'
